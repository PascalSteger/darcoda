...
errorbar(rmed1,phimed1,phierrl1./sqrt(nnzj1),phierru1./sqrt(nnzj1),'Marker','hexagram','LineStyle','-','Color',[1 0 0]);hold off;
axis([xmin,xmax,0,1]);
xlabel('T1');
...
errorbar(rmed2,phimed2,phierrl2./sqrt(nnzj2),phierru2./sqrt(nnzj2),'Marker','hexagram','LineStyle','-','Color',[1 0 0]);hold off;
axis([xmin,xmax,0,1]);  
