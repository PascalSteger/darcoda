...
The main idea is to let an Monte Carlo Markov Chain marginalize over
...
\TODO{reference why 0.25 is best acceptance rate}
...
After a burn-in phase of several 100 accepted models with
