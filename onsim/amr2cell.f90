program amr2cell
  ...
  real(dp=8),dimension(1:8)::bounding_min,bounding_max
  real(dp)::dkey,order_min,dmax,dummy
        ...
        if(ngrida>0)then
           ...
           do ind=1,twotondim
              ...
              do i=1,ngrida
                 ...
                 if(ok_cell)then
                    do ivar=6,nvarh
                      var(i,ind,ivar)=max(var(i,ind,ivar),1d-99)
                    enddo
...
999 format(4(1pe12.5,1x),2(i6,1x),15(1pe10.3,1x))
