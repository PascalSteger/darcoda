program part2map
  ...
  real(KIND=8)::mtot,ddx,ddy,dex,dey,time,time_tot,time_simu,weight,boxlen
  ...
  real(KIND=8),dimension(:)  ,allocatable::m,age,star_metal,dum
  ...
  integer,dimension(:),allocatable::cpu_list,iia,id_star
        ...
        do i=1,npart2
           ...
           if(ok_part)then
              ...
              if(star)then 
                ...
                print "(4(1pe15.8,1X),I8,1X,3(1pe15.8))", m(i)*unit_d*unit_l**3/2d33,x(i,1),x(i,2),x(i,3),id_dm(i), &
