...
IF (dowhich EQ 'sim') THEN BEGIN
   ...
   betano = '12'
   whichsim = '1'
   basename = '/home/ast/read/dark/davev/sphericalmethod_output/dual_unit_hern_'+whichsim+'/M'+Mno+'_nu'+nuno+'_beta'+betano+'_los/met'
   massfile = '/home/ast/read/dark/davev/sphericalmethod_data/enclosedmass/dual_unit_hern_'+whichsim+'_tot_enclosedmass.txt'
   if (populations eq 2) then begin
      nufile1 = '/home/ast/read/dark/davev/sphericalmethod_data/densityfalloff/dual_unit_hern_'+whichsim+'_stars_falloff.txt'
      sigfile1 = '/home/ast/read/dark/davev/sphericalmethod_data/velocitydispersionlos/dual_unit_hern_'+whichsim+'_stars_veldisplos_cut.txt'
      nufile2 = '/home/ast/read/dark/davev/sphericalmethod_data/densityfalloff/dual_unit_hern_'+whichsim+'_dm_falloff.txt'
      sigfile2 = '/home/ast/read/dark/davev/sphericalmethod_data/velocitydispersionlos/dual_unit_hern_'+whichsim+'_dm_veldisplos_cut.txt'
      sigrfile1 = '/home/ast/read/dark/davev/sphericalmethod_data/velocitydispersion/dual_unit_hern_'+whichsim+'_'+whichpop+'_veldisp.txt'
   endif
   IF (populations eq 1) then begin
      nufile1 = '/home/ast/read/dark/davev/sphericalmethod_data/densityfalloff/dual_unit_hern_'+whichsim+'_'+whichpop+'_falloff.txt'
      sigfile1 = '/home/ast/read/dark/davev/sphericalmethod_data/velocitydispersionlos/dual_unit_hern_'+whichsim+'_'+whichpop+'_veldisplos_cut.txt'
      sigrfile1 = '/home/ast/read/dark/davev/sphericalmethod_data/velocitydispersion/dual_unit_hern_'+whichsim+'_'+whichpop+'_veldisp.txt'
   ENDIF
   dosim = 'yes'
ENDIF
...
readcol,sigrfile1,r_sigrdat,sigr_dat,sigr_dat_err
