...
\caption{Reconstructed mass of a cusped model (red shows median,
  ...
  theoretical model. \TODO{log-log scale}}
\label{fig:cusp}
\end{center}
\end{figure*}
...
\begin{center}
\hspace{-7mm}
\includegraphics[width=0.5\textwidth]{fig/nufit.pdf}
\includegraphics[width=0.5\textwidth]{fig/sigfit.pdf}
\caption{Fitted $\nu_1(r)$ and $\siglos_1(r)$ for the first of two stellar components in the cusped profile of fig. \ref{fig:cusp}.}
\label{fig:nusiglos}
\end{center}
\end{figure*}

\TODO{observations? goodness of fit?}
\TODO{fixed nu_1, beta_2, tuning other two of them}
...
\begin{center}
\hspace{-7mm}
\includegraphics[width=0.5\textwidth]{fig/beta1fit.pdf}
\includegraphics[width=0.5\textwidth]{fig/beta2fit.pdf}
...
\TODO{observations? goodness of fit?}
\TODO{ref for prior beta>0 after some x*r_s}
