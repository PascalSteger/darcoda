...
IF (plotwhich EQ 'sim') THEN BEGIN
   ...
   basename = '/home/ast/read/dark/davev/justinmethod_output/Grav_image_disc/mwhr_r8500/met_ang'+patch+'_8_mirr_bprior_constdm'
...
IF (plotwhich EQ 'simple') THEN BEGIN
   basename = $
      '/home/ast/read/dark/davev/justinmethod_output/Grav_image_disc/simpletest/1comp_kzmin01_1e4_8_mirr_log_bprior_constdm'
