...
#define MAX_NPROG_FOR_MERGER_CHECK            3000000        // maximum number of progenitors to check for a possible merger (non-Gottloeber rates)
...
int main()
{
  ...
  if(need_simuparams) {
    ...
    // make these parameters avaibale to calc_t() and read_zred()
    simu.omega0  = omega0;
