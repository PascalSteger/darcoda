...
In addition to the above Walker mocks, we add also a mock dwarf with
...
\begin{figure*}
    \begin{center}
        ...
        \caption{Density profile of a cored \TODO{triaxial} mock
...
particles are then split into two populations of each $5\cdot10^3$
...
\begin{figure*}
    \begin{center}
        ...
        \caption{\TODO{Gaia01} profile found by MCMC model (red)
          for $10^3$, $10^4$ and two times $5\cdot10^3$ tracer
          particles. The black curve shows the enclosed mass derived
