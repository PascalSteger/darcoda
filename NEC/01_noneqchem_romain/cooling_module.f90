...
#endif
! the following are only used for noneqchem, but must be outside if the preprocessing region
! so they the code compiles for nonhydro jobs.
  real(kind=8),save::ism_N=1d21,ism_grain_a=1e-4
  real(kind=8),save::step_frac=0.1,jeans_ncells=4.0,fixedMu=1.22
