...
subroutine star_formation(ilevel)
  ...
  ! other variables
  integer ::ncache,nnew,ivar,ngrid,icpu,index_star,ndebris_tot,nn,ii
  integer ::igrid,ix,iy,iz,ind,i,j,n,iskip,istar,inew,nx_loc
  integer ::ntot,ntot_all,info,nstar_corrected,ideb,ndeb,fragment
...
#ifdef NONEQCHEM
              ![PS] make sure to adjust chemical species, too.
              nn=neq_spec-1
              d=0d0
              do ii=1,nn
