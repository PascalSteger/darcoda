...
def geom_loglike(cube, ndim, nparams, gp):
    ...
    for pop in np.arange(gp.pops)+1:
        ...
        nuparstore.append(nupar)
        
        tmp_nu = phys.rho(gp.xepol, nupar, pop, gp) #  [1], [pc]
        ...
        #try:
        # TODO: check integration is fine
        sig = phys.sigz(gp.xepol, rhopar, nupar, 17.**2, tiltpar, pop, gp)
        # sig, kap = sig_kap_los(gp.xepol, pop, rhopar, nupar, tiltpar, pop, gp)
