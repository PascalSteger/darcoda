...
def rho_INTIPOL_Rho(r0, rho):
    ...
    for i in range(pnts):
        ...
        # yint[0] = gh.ipol(xipol[1:3], yipol[1:3], xint[0], smooth=0.1) # higher smooth means lower sig_los
    ...
    # extrapolate to last 4 bins, which were neglected for sake of
    # extrapolating yint[0]
