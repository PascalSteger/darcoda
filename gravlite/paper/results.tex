...
\begin{figure*}
    \begin{center}
        % cored profile
        \includegraphics[width=0.33\textwidth]{fig/Gaia04/output/pdf/prof_rho_0}\hspace{-3mm}
        \includegraphics[width=0.33\textwidth]{fig/Gaia04/output/pdf/prof_nr_0}\hspace{-3mm}
        \includegraphics[width=0.33\textwidth]{fig/Gaia04/output/pdf/prof_betastar_1}

        % cusped profile
        \includegraphics[width=0.33\textwidth]{fig/Gaia01/output/pdf/prof_rho_0}\hspace{-3mm}
        \includegraphics[width=0.33\textwidth]{fig/Gaia01/output/pdf/prof_nr_0}\hspace{-3mm}
        \includegraphics[width=0.33\textwidth]{fig/Gaia01/output/pdf/prof_betastar_1}
...
\begin{figure*}
    \begin{center}
        % cored profile
        \includegraphics[width=0.33\textwidth]{fig/Gaia04/output/pdf/prof_Sig_1.pdf}
        \includegraphics[width=0.33\textwidth]{fig/Gaia04/output/pdf/prof_sig_1.pdf}

        % cusped profile
        \includegraphics[width=0.33\textwidth]{fig/Gaia01/output/pdf/prof_Sig_1.pdf}
        \includegraphics[width=0.33\textwidth]{fig/Gaia01/output/pdf/prof_sig_1.pdf}
...
(fig. \ref{fig:triax}) recaptures the density
inside the half-light radius, but constantly
overestimates it at $r>r_{1/2}$. This is partly
due to projection effects, as the underlying
density profile in blue is calculated for
spherically averaged density decrease.
...
\TODO{Redo the analysis using, say, the cusped Walker data
  set to be consistent with all other tests presented in the paper. Perhaps show
  what happens with $10^5$ tracers? (we can dare to dream).}
