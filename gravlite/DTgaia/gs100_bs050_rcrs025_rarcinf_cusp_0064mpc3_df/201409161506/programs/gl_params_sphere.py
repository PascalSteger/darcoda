...
class Params():
    def __init__(self, timestamp = ''):
        ...
        self.case = 7 # gaia models (1..8) Walker (0..2,4,5; use 1, 2)
        ...
        self.chi2_switch = 100000.
        # Set number of terms for enclosedmass+tracer+anisotropy bins
        # = model parameters:
        self.nipol = 36   # IF CHANGED => set getnewdata = True to run
                         # data readout again
        ...
        self.nbeta = 7   # number of parameters for beta, in sum of
                         # polynomials
