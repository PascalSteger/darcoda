    ...
    def read_Sig(self, gp):
        for pop in np.arange(gp.pops+1):
            ...
            if gp.geom == 'sphere':
                ...
                dummy, nudatnu, nuerrnu, Mrdatnu = Rho_NORM_rho(gp.xfine, Sigdatnu, Sigerrnu, gp)
