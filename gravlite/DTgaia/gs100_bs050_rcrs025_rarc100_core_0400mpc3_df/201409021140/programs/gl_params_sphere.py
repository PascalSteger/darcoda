...
class Params():
    def __init__(self, timestamp = ''):
        ...
        ########## MultiNest options
        self.chi2_Sig_converged = False
        self.chi2_switch = 10000.
        # Set number of terms for enclosedmass+tracer+anisotropy bins
        # = model parameters:
        self.nipol = 16   # IF CHANGED => set getnewdata = True to run
                         # data readout again
        ...
        self.nrho = self.nipol + 2*self.nexp + 3 # +3 means 1 more
                                                ...
                                                # the asymptote to
                                                # \infty
        self.nfine = 32  # number of entries in integral lookup table
        ...
        self.nbeta = 2   # number of parameters for beta, in sum of
                         # polynomials
        ...
        self.nrtol_nu = 2./(8./self.nipol) # max change in dn(r)/d log(r)
