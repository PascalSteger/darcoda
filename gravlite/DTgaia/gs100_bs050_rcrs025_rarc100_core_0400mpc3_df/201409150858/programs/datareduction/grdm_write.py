...
def run(gp):
    ...
    Mrdat1 = np.cumsum(counts)
    Mrerr1 = np.sqrt(Mrdat1) # TODO
    ...
    if gp.pops == 2:
        ...
        Mrdat2 = np.cumsum(counts)
        Mrerr2 = np.sqrt(Mrdat2) # TODO
