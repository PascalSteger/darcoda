...
class Files:
    ...
    def set_discsim(self, gp, timestamp=''):
        ...
        self.Sigfiles.append(self.dir + 'Sig/mwhr_r8500_ang'+gp.patch+'_falloff_stars.txt') # first comp
        ...
        if gp.pops ==2:
            ...
            self.Sigfiles.append(self.dir + 'Sig/mwhr_r8500_ang'+gp.patch+'_falloff_dm.txt') # second comp.
    ...
    def set_discmock(self, gp, timestamp=''):
        ...
        self.Sigfiles.append(self.dir+'Sig/Sig_0.txt')
        ...
        self.Sigfiles.append(self.dir+'Sig/Sig_1.txt')
        ...
        if gp.pops == 2:
            ...
            self.Sigfiles.append(self.dir+'Sig/Sig_2.txt')
