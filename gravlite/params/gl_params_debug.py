...
##
# @file
# parameters for the gravlite MCMC, used for debugging
...
case = 2           # choose different Walker models (0-2 so far)
...
Mscale = 1.e6                           # [Msun], scale for dimensionless equations
                                        # from Hernquist, Baes&Dejonghe, Zhang
ascale = 1000.                          # [pc]
