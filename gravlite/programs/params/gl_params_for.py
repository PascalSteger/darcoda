...
class Params():
    def __init__(self):
        ...
        self.investigate  = 'obs' # determine which data set to work on
                        ...
                        # 'obs': real data from Fornax/Carina/Sextans/. dwarf galaxy

        self.case = 'for' # choose gaia models (1..8) or Walker (0..2,4,5) models, or triax models (0:core, 1:cusp), or dwarf (for, car, sex, scl)
        ...
        #             ntracer = 1e4              # case 2
        self.ntracer = [10000, 0] # pop1, pop2, ..., pop_N (and take sum for all tracers)
