...
class Params():
    def __init__(self):
        ...
        self.case = 4 # choose gaia models (1..8) or Walker (0..2,4,5) models, or triax models (0:core, 1:cusp)
        ...
        #             ntracer = 1e4              # case 2
        self.ntracer = [100, 100] # pop1, pop2, ..., pop_N (and take sum for all tracers)
