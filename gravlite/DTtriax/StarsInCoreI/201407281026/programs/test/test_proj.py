...
nuanf  = ga.rho_anf(r0, 1, 1/MtoL)
Siganf = ga.Sig_anf(r0, 1, 1/MtoL)
...
dummy, nudatnu, nuerrnu, Mrdatnu = glp.Rho_NORM_rho(rfine, Sigdatnu, Sigerrnu)

# loglog(r0, nuanf, 'b.-')
# loglog(rfine, nudatnu, '.', alpha=0.5)
